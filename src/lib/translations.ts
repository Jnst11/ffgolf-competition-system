...
export const DEFAULT_TRANSLATIONS: Translation[] = [
  ...
  },
  {
    ...
    key: 'golf.editGolfer',
    en: 'Edit Golfer',
    fr: 'Modifier le golfeur',
    category: 'golf',
    lastModified: new Date().toISOString(),
  },
  {
    id: '207',
    key: 'golf.deactivateGolfer',
    en: 'Deactivate',
    fr: 'Désactiver',
    category: 'golf',
    lastModified: new Date().toISOString(),
  ...
  {
    id: '214',
    key: 'golf.showInactiveGolfers',
    en: 'Show Inactive',
    fr: 'Afficher inactifs',
    category: 'golf',
    lastModified: new Date().toISOString(),
  },
  {
  ...
  {
    id: '217',
    key: 'golf.addNewGolfer',
    en: 'Add New Golfer',
    fr: 'Ajouter un nouveau golfeur',
    category: 'golf',
    lastModified: new Date().toISOString(),
  },
  {
    id: '218',
    key: 'golf.namePlaceholder',
    en: 'Enter golfer name',
    fr: 'Entrez le nom du golfeur',
    category: 'golf',
    lastModified: new Date().toISOString(),
  },
  {
  ...
  {
    id: '220',
    key: 'golf.homeClubPlaceholder',
    en: 'Enter home club name',
    fr: 'Entrez le nom du club d\'origine',
    category: 'golf',
    lastModified: new Date().toISOString(),
  },
  {
    id: '221',
    key: 'golf.teeTimeAssignment',
    en: 'Tee Time Assignment',
    fr: 'Attribution des heures de départ',
    category: 'golf',
    lastModified: new Date().toISOString(),
  },
];
