    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-slate-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <h2 className="mt-6 text-center text-3xl font-bold text-gray-900">
          {t('auth.loginToAccount', 'Connexion à votre compte')}
        </h2>
        <p className="mt-2 text-center text-sm text-gray-600">
          {t('competition.teamCompetitionManagement', 'Système de gestion des compétitions par équipes')}
        </p>
      </div>
          ...
          <div className="mt-8">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white text-gray-500">Connexion démo</span>
              </div>
            </div>
            ...
            <div className="mt-4 text-xs text-gray-500 text-center">
              <p>Comptes de démonstration - Aucun mot de passe requis</p>
            </div>
          </div>

          <div className="mt-6">
            <div className="text-center">
              <Link href="/" className="text-sm text-ffgolf hover:text-ffgolf-800">
                ← Retour à l'accueil
              </Link>
            </div>
          </div>
