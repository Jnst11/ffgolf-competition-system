...
const bracketData = {
  id: '1',
  name: 'Division 1 Championship Bracket',
  type: 'promotion',
  status: 'in_progress',
  venue: 'Golf National',
...
// Teams from the qualification event (seeds 1-8)
const qualifiedTeams = [
  { seed: 1, team: 'Golf Club de Paris', totalScore: 285, status: 'qualified' },
  { seed: 2, team: 'RC Bordeaux Golf', totalScore: 287, status: 'qualified' },
  { seed: 3, team: 'Golf de Lyon', totalScore: 289, status: 'qualified' },
  { seed: 4, team: 'AS Monaco Golf', totalScore: 291, status: 'qualified' },
  { seed: 5, team: 'Marseille Golf Club', totalScore: 293, status: 'qualified' },
  { seed: 6, team: 'Toulouse FC Golf', totalScore: 295, status: 'qualified' },
  { seed: 7, team: 'Lille OSC Golf', totalScore: 297, status: 'qualified' },
  { seed: 8, team: 'Strasbourg Golf', totalScore: 299, status: 'qualified' }
]

// Bracket matches with proper seeding structure: 1v8, 4v5, 2v7, 3v6
const bracketMatches = {
  quarterFinals: [
    {
      id: 'qf1',
      match: 'Quarter-Final 1',
      team1: { seed: 1, name: 'Golf Club de Paris', score: null },
      team2: { seed: 8, name: 'Strasbourg Golf', score: null },
      status: 'scheduled',
      date: '20 Mai 2024',
      time: '09:00'
    },
    {
      ...
      team1: { seed: 4, name: 'AS Monaco Golf', score: null },
      team2: { seed: 5, name: 'Marseille Golf Club', score: null },
      status: 'scheduled',
      date: '20 Mai 2024',
      time: '09:30'
    },
    {
      ...
      team1: { seed: 2, name: 'RC Bordeaux Golf', score: null },
      team2: { seed: 7, name: 'Lille OSC Golf', score: null },
      status: 'scheduled',
      date: '20 Mai 2024',
      time: '10:00'
    },
    {
      ...
      team1: { seed: 3, name: 'Golf de Lyon', score: null },
      team2: { seed: 6, name: 'Toulouse FC Golf', score: null },
      status: 'scheduled',
      date: '20 Mai 2024', 
      time: '10:30'
    }
...
export default function TeamMatchBracketPage() {
  ...
  const MatchCard = ({ match, isSmall = false }: { match: any, isSmall?: boolean }) => (
    <div className={`bg-white border-2 border-gray-200 rounded-lg p-4 hover:border-ffgolf transition-colors ${isSmall ? 'w-48' : 'w-64'}`}>
      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between p-2 bg-gray-50 rounded">
          <div className="flex items-center">
            {match.team1.seed && (
              <span className="inline-flex items-center justify-center w-6 h-6 bg-ffgolf text-white text-xs font-bold rounded-full mr-2">
                {match.team1.seed}
              </span>
            )}
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              ...
              <span className="ml-4 px-3 py-1 text-xs font-medium bg-green-50 text-green-800 rounded">
                {t('bracket.promotion', 'Bracket de Promotion')}
              </span>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div>
              ...
              <div className="mt-2 flex items-center space-x-6 text-sm text-gray-500">
                <span className="flex items-center">
                  ...
                  {t('bracket.promotion', 'Promotion')} • 8 {t('team.teams', 'équipes')}
                </span>
        ...
        <div className="bg-white shadow rounded-lg mb-8 p-6">
          <h2 className="text-lg font-medium text-gray-900 mb-4">{t('bracket.qualifiedTeams', 'Équipes Qualifiées')}</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {qualifiedTeams.map((team) => (
              <div key={team.seed} className="flex items-center p-3 bg-green-50 rounded-lg">
                <span className="inline-flex items-center justify-center w-8 h-8 bg-green-600 text-white text-sm font-bold rounded-full mr-3">
                  {team.seed}
                </span>
                <div>
        ...
        <div className="bg-white shadow rounded-lg p-8">
          <h2 className="text-xl font-bold text-gray-900 mb-8 text-center">
            {t('bracket.tournamentBracket', 'Tournament Bracket')}
          </h2>
